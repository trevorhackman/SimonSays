...
enum class ColorSet(@StringRes override val nameId: Int, @Size(4) @ColorRes val colorResources: List<Int>) :
    NameId {
...
private val classicColors = listOf(R.color.classic0, R.color.classic1, R.color.classic2, R.color.classic3)
...
private val invertedColors = listOf(R.color.inverted0, R.color.inverted1, R.color.inverted2, R.color.inverted3)
